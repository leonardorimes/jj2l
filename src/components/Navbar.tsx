    ...
    <nav className={styles.navbar}>
      <div className={styles.container}>
        ...
        <ul className={styles.navLinks}>
          ...
          <li><Link href="/#contact" className={styles.navLink} onClick={(e) => handleScrollToSection(e, 'contact')}>CONTACT</Link></li>
        </ul>
        ...
        <div className={styles.actions}>
          ...
          <Link href="/#contact" className={styles.estimateBtn} onClick={(e) => handleScrollToSection(e, 'contact')}>
            Free Estimate
          </Link>
        </div>
      </div>
